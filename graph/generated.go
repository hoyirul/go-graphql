...
type ComplexityRoot struct {
	Mutation struct {
		AddProduct func(childComplexity int, name string, price float64) int
	}
...
type MutationResolver interface {
	AddProduct(ctx context.Context, name string, price float64) (*Product, error)
}
...
func (e *executableSchema) Complexity(ctx context.Context, typeName, field string, childComplexity int, rawArgs map[string]any) (int, bool) {
	...
	case "Mutation.addProduct":
		...
		return e.complexity.Mutation.AddProduct(childComplexity, args["name"].(string), args["price"].(float64)), true
...
func (ec *executionContext) _Mutation_addProduct(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (any, error) {
		...
		return ec.resolvers.Mutation().AddProduct(rctx, fc.Args["name"].(string), fc.Args["price"].(float64))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	...
	res := resTmp.(*Product)
	fc.Result = res
	return ec.marshalNProduct2ᚖgithubᚗcomᚋhoyirulᚋgoᚑgraphqlᚋgraphᚐProduct(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_products(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.([]*Product)
	fc.Result = res
	return ec.marshalNProduct2ᚕᚖgithubᚗcomᚋhoyirulᚋgoᚑgraphqlᚋgraphᚐProductᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNProduct2githubᚗcomᚋhoyirulᚋgoᚑgraphqlᚋgraphᚐProduct(ctx context.Context, sel ast.SelectionSet, v Product) graphql.Marshaler {
	return ec._Product(ctx, sel, &v)
}

func (ec *executionContext) marshalNProduct2ᚕᚖgithubᚗcomᚋhoyirulᚋgoᚑgraphqlᚋgraphᚐProductᚄ(ctx context.Context, sel ast.SelectionSet, v []*Product) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNProduct2ᚖgithubᚗcomᚋhoyirulᚋgoᚑgraphqlᚋgraphᚐProduct(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNProduct2ᚖgithubᚗcomᚋhoyirulᚋgoᚑgraphqlᚋgraphᚐProduct(ctx context.Context, sel ast.SelectionSet, v *Product) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
